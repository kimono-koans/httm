    ...
    clap::Command::new("httm")
        ...
        .arg(
            Arg::new("INTERACTIVE")
                .short('i')
                .long("interactive")
                .help("use native dialogs for an interactive file lookup session.")
                .multiple_values(true)
                .display_order(2)
        )
        .arg(
            Arg::new("SELECT")
                .short('s')
                .long("select")
                .help("use native dialogs for an interactive file lookup and file select.")
        ...
        .arg(
            Arg::new("RESTORE")
                .short('r')
                .long("restore")
                .help("use native dialogs for an interactive file restore from backup.")
